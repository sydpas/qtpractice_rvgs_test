...
from repsec_code.rs_assembly_3 import (organize_curves)
...
class WellLogPlotter(FigureCanvas):
    ...
    def load_data(self):
        _, _, _, self.df, loc, comp = repsec_well()
    ...
    def plotting_logs(self):
        ...
        """
        global current_ax
        columns, non_depth_curves, curve_unit_list, df, loc, comp = repsec_well()
